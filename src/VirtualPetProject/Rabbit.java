...
public class Rabbit extends Animal {
    ...
    public void fulfillNeed(int need) {
        ...
        switch (need) {
            ...
            case 6: // Fun
                ...
                break;
            default:
                System.out.println("Invalid need for a Rabbit.");
        }
    }
            ...
            try {
                ...
                switch (socialOption) {
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println("You groomed " + petName + " a belly rub.");
                        ...
                        break;
                    case 3:
                        System.out.println("You snuggled " + petName);
    ...
    public void fulfillFun(){
        ...
        do {
            ...
            System.out.println("1. Chew toy\n2. Tunnel\n3. Cardboard box");
            try {
                funOption = UserInterface.getUserIntChoice();;
                switch (funOption) {
                    case 1:
                        System.out.println(petName + " played with the chew toy.");
                        setFun(getFun() + 20);
                        setEnergy(getEnergy() - 10);
                        setHunger(getHunger() - 10);
                        ...
                        break;
                    case 2:
                        System.out.println(petName + " enjoyed playing in the tunnel.");
                        setFun(getFun() + 30);
                        setEnergy(getEnergy() - 10);
                        setHunger(getHunger() - 10);
                        setHygiene(getHygiene() - 10);
                        break;
                    case 3:
                        System.out.println(petName + " had fun playing in the cardboard box.");
                        setFun(getFun() + 40);
                        setEnergy(getEnergy() - 20);
                        setHunger(getHunger() - 20);
                        setHygiene(getHygiene() - 20);
