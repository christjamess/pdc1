...
public class Dog extends Animal {
    ...
    public void fulfillNeed(int need) {
        ...
        switch (need) {
            ...
            case 6: // Fun
                ...
                break;
            default:
                System.out.println("Invalid need for a Dog.");
        }
    }
    ...
    public void fulfillHunger(){
        ...
        do {
            ...
            System.out.println("1. Dog food\n2. Bones\n3. Treat");
            try {
                foodOption = UserInterface.getUserIntChoice();
                switch (foodOption) {
                    case 1:
                        System.out.println("\nYou fed " + petName + " dog food.");
            ...
            try {
                ...
                switch (socialOption) {
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println("You gave " + petName + " a belly rub.");
    ...
    public void fulfillBladder(){
        System.out.println(petName + " relieved themself.");
    ...
    public void fulfillHygiene(){
        System.out.println("You washed " + petName);
    ...
    public void fulfillFun(){
        ...
        do {
            ...
            try {
                ...
                switch (funOption) {
                    case 1:
                        System.out.println(petName + " played with the tennis ball.");
                        setFun(getFun() + 20);
                        setEnergy(getEnergy() - 10);
                        setHunger(getHunger() - 10);
                        ...
                        break;
                    case 2:
                        System.out.println(petName + " enjoyed playing with the chew toy.");
                        setFun(getFun() + 30);
                        setEnergy(getEnergy() - 10);
                        setHunger(getHunger() - 10);
                        setHygiene(getHygiene() - 10);
                        break;
                    case 3:
                        System.out.println(petName + " had fun playing with the frisbee.");
                        setFun(getFun() + 40);
